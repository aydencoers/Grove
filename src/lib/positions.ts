  ...
  },
  {
    ...
    journal: [
      ...
      },
      {
        ...
        body: "Deere makes agricultural and construction machinery — the green tractors and combines on farms, plus road-building and forestry equipment. Its results tend to rise and fall with farm incomes, crop prices, and interest rates, which makes the stock fairly cyclical. There is no price move to explain yet; this entry just marks the day the seed went in. Forty shares at $640.00.",
        sources: [
          {
